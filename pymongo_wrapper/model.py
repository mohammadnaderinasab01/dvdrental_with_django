...
from .decorators import notinstancemethod
from .cursor import Cursor
from .field import Field, EmptyRequiredField
from .helpers import check_none, Document
...
class Model(metaclass=NewModelClass):
    ...
    def _auto_create_fields(self: M) -> bool:
        ...
        return pymongo_wrapper.AUTO_CREATE_FIELDS
